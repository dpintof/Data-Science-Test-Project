...
# -*- coding: utf-8 -*-
"""
Created on Fri Jul  2 15:12:38 2021
...
# FITTING SVM TO ENCODED DATA AND CALCULATING THE MODEL'S ACCURACY
...
scores2 = cross_val_score(svm_model, X, y, cv = 5, scoring = "precision")
...
y_score2 = cross_val_predict(svm_model, X, y, method='predict_proba')
...
my_value = cross_validate(svm_model, X, y, scoring = myscore)
